...
INSERT INTO `system_procedure` VALUES ('10', '1', 'newCompressorCurveTest', '导入:importFile,分析:analysis,测试条件:setTestStatus,导入数据:importTest', 'compressorTools4LangFang', '6.1压缩机特性测试', '11', null, null, null);
INSERT INTO `system_procedure` VALUES ('11', '0', 'importLangFangFile', null, 'compressorTools4LangFang', '6.廊坊项目', '10', null, null, null);
